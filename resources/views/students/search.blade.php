                    ...
                    <form id="addStudentForm" action="{{ route('save_student') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            @if(Auth::user()->college)
                                <!-- Hide input and automatically put college data base on the account -->
                                <input type="hidden" name="college" id="college" value="{{ Auth::user()->college }}">
                            @else
                                <!-- Manual input if college is null -->
                                <label for="college">College (Manual Input)</label>
